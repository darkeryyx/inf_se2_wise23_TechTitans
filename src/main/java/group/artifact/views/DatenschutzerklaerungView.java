...
public class DatenschutzerklaerungView extends FlexLayout{
    ...
    public DatenschutzerklaerungView(){
       ...
       + "<p>Max Mustermann<br>Musterstr. 1<br>54321 Musterstadt</p>"
       + "E-Mail-Adresse: <a href=\"mailto:max.mustermann@test.de\">max.mustermann@test.de</a>"
       + "Impressum: <a href=\"/impressum\">/impressum</a>"
       + "<h2 id=\"m11\">Kontakt Datenschutzbeauftragter</h2>"
       + "<p><a href=\"mailto:John@doe.com\">John@doe.com</a></p>"
